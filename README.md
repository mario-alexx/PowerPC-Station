...
You can see a live demo of this project [here](powerpc-station.azurewebsites.net).
...
git clone https://github.com/mario-alexx/PowerPC-Station.git
cd PowerPC-Station
```
...
```bash
# From the solution folder (PowerPc-Station)
dotnet restore
...
```bash
# in the PowerPc-Station folder (root directory of the app)
docker compose up -d 
```
